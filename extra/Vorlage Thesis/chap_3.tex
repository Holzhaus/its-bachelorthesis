...
So, testing abbrevations the \ac{AES} is written in different form. Lets see, when using the \ac{AES} again, what will happen :D .
...
\begin{figure}[p]
  \centering
  \hfill %
  \subfloat[Opened Nissan car key.]{\includegraphics[width=2.35in]{images/NissanSchluessel1}}
  \hfill %
  \subfloat[Closeup of the transponder (PCF7946).]{\includegraphics[width=2.35in]{images/NissanSchluessel2}}
...
\begin{figure}[p]
 \ContinuedFloat
  \centering
  \hfill %
  \subfloat[Carbon type transponder.]{\includegraphics[width=2.35in]{images/PCF7936a}}
  \hfill %
  \subfloat[Disc type transponder.]{\includegraphics[width=2.35in]{images/WorldTag}}
