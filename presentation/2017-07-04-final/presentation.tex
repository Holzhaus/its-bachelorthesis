...
\begin{frame}
  ...
  \begin{itemize}
    ...
    \item{} Json.NET converts them to \emph{JavaScript}-style block comments (\mintinline{javascript}{/* Comment */})
...
\begin{frame}
  ...
  \framesubtitle{}
  \begin{itemize}
    \item{} CobraVsMongoose, Json-lib and org.json.XML only support ASCII characters
