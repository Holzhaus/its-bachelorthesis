...
Die vorliegende Arbeit befasstwird sich mit der verlustfreien Translation von
XML-Daten in JSON-Strukuren. Dazu werden bestehende Verfahren
...
JSON sowie in Rückrichtung entwickelt und vorgestellt.
\end{abstract}
