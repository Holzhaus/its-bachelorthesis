\begin{abstract}
Bei \acrshort{xml} und \acrshort{json} handelt es sich um insbesondere im Mobile- und % chktex 8
...
Die vorliegende Arbeit befasst sich mit der verlustfreien Translation von
\acrshort{xml}-Daten in \acrshort{json}-Strukuren. Dazu werden bestehende Verfahren
auf Genauigkeit und Sicherheit hin untersucht und schlussendlich
ein verlustfreies Verfahren zur Übersetzung von \acrshort{xml}-Daten in
\acrshort{json} sowie in Rückrichtung entwickelt und vorgestellt.
\end{abstract}
