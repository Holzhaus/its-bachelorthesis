...
Da für viele XML-Strukturen kein Äquivalent in der \acrshort{json}-Spezifikation existiert, gibt es meist verschiedene Möglichkeiten der Abbildung von XML-Inhalten in \acrshort{json}.
