...
Ebenso wie Kommentare sind sie nicht Teil der Zeichendaten eines \acrshort{xml}-Dokuments, müssen jedoch laut Spezifikation zwingend vom \acrshort{xml}-Parser an die verarbeitende Applikation weitergereicht werden~\cite[Abschn.~2.6]{maler2008xml}.
