...
\begin{samepage}
    ...
    \begin{enumerate}
        \item{} Zeilenenden, d.h. die verschiedenen Kombinationen der Wagenrücklauf- und Zeilenvorschub-Zeichen, werden zu einem einfachen Zeilenvorschub umgewandelt ~\cite[Abschn.~2.11]{maler2008xml}.
...
Zwar kann Whitespace durch \glspl{dtd} oder \acrshort{XSD}-Schemata auch als unsignifikant markiert werden~\cite{page2005whitespace}, dies wird jedoch nur von \enph{validierenden} XML-Prozessoren beachtet und geht somit über den Rahmen der vorliegenden Arbeit hinaus.
...
\begin{description}
    ...
    %FIXME: Quelle
    \item[x2js] Die JavaScript-Bibliothek ist mit 475 Sternen und 219 Forks auf GitHub\footnote{Stand: \DTMdate{2017-06-21}} recht populär~\cite{githubx2js} und erlaubt eine große Zahl von Einstellungsmöglichkeiten.
